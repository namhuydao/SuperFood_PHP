...
//  Truy vấn ra tổng bản ghi của bảng news
$count = $conn->query('SELECT COUNT(id) AS total FROM news');
$count = $count->fetch_assoc();
$total = $count['total'];   //  tổng bản ghi trong bảng news

$sql = "SELECT * FROM `news` ORDER BY id DESC LIMIT $per_page";
