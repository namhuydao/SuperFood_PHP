                ...
                <div class="slider__item-content ml-auto animate__animated animate__fadeInRight wow"
                    ...
                    <p class="content__text">Spadefish tiger shark Alaska blackfish wels catfish plaice four-eyed
                        fish peladillo glass knifefish sbasis, taking local availability.</p><a
                            class="btn btn-color" href="#">Read More</a>
                </div>
            </div>
        </div>
        <div class="slider__item">
                ...
                <div class="about__box animate__animated animate__fadeInLeft wow" data-wow-delay="0.5s">
                    ...
                    <div class="about__box-item animate__animated animate__fadeInUp wow" data-wow-delay="1s">
                        ...
                        <p class="item__text">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
                            nonumy eirmod tempor invidunt.</p><a class="btn btn-color" href="#">Xem Thêm</a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-lg-4 p-0">
                <div class="about__box animate__animated animate__fadeInUp wow" data-wow-delay="1.5s">
                    ...
                    <div class="about__box-item animate__animated animate__fadeInUp wow" data-wow-delay="2s">
                        ...
                        <p class="item__text">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
                            nonumy eirmod tempor invidunt.</p><a class="btn btn-white" href="#">Xem Thêm</a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-lg-4 p-0">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-8 mx-auto text-center animate__animated animate__zoomIn wow"
                ...
                <p class="title__text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed eiusmod. Lorem
                    ipsum dolor Tur adipiscing elit, sed do eiusmod.</p>
            </div>
        </div>
    </div>
    <div class="container-fluid">
            ...
            <div class="col-12 col-sm-6 col-lg-3 p-0">
                <div class="clients__box animate__animated animate__fadeInUp wow" data-wow-delay="1s">
                    ...
                    <div class="clients__box-item">
                        ...
                        <div class="item__icon"><a class="item__icon-link" href="#"><i class="fab fa-instagram"></i></a><a
                                    class="item__icon-link" href="#"><i class="fab fa-twitter"></i></a><a
                                    class="item__icon-link" href="#"><i class="fab fa-facebook-f"></i></a><a
                                    class="item__icon-link" href="#"><i class="fab fa-tumblr"></i></a></div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-lg-3 p-0">
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-4 col-md-4 my-sm-auto">
                <div class="contact__button text-sm-right animate__animated animate__fadeInUp wow"
                     data-wow-delay="1s"><a class="btn btn-color" href="#">Liên hệ ngay</a></div>
            </div>
        </div>
    </div>
</div>
