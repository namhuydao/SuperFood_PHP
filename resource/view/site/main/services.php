...
<!-- Start Services-->
<div class="services">
    <div class="services__background"><img src="../images/layout/item-3.png" alt=""></div>
    <div class="container">
        <div class="row">
        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-3">
                <div class="services__box">
                    ...
                    </svg></span><img src="../images/layout/circle-1.png" alt=""></div>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="services__box">
                    ...
                    </svg></span><img src="../images/layout/circle-2.png" alt=""></div>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="services__box">
                    ...
                    </svg></span><img src="../images/layout/circle-3.png" alt=""></div>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="services__box">
                    ...
                    </svg></span><img src="../images/layout/circle-4.png" alt=""></div>
                    <div class="services__box-content animate__animated animate__fadeInUp wow"
                         data-wow-delay="2.5s">
...
<div class="promotion">
    <div class="promotion__background animate__animated animate__zoomIn wow" data-wow-delay="0.5s"><img
                src="../images/services/promotion.png" alt=""></div>
    <div class="container h-100">
        <div class="row h-100">
            <div class="col-12 my-auto">
                <div class="promotion__content ml-auto animate__animated animate__fadeInRight wow"
                     data-wow-delay="1s">
                    <div class="promotion__content-image"><img src="../images/layout/item-1.png" alt=""></div>
            ...
            <div class="col-12 col-lg-6 order-lg-2">
                <div class="video__box">
                    <div class="video__box-video animate__animated animate__zoomIn wow" data-wow-delay="0.5s"><img
                                src="../images/services/video.jpg" alt="">
