...
<div class="wrapper">
    <!-- Start PreLoader-->
<!--    <div class="preLoader">-->
<!--        <div class="preLoader__image"><img src="images/layout/leaf.png" alt=""></div>-->
<!--    </div>-->
    <!-- End PreLoader-->
    <!-- Start Header-->
            ...
            <div class="header__menu">
                ...
                <div class="accordion-menu">
                    ...
                    <ul class="header__menu-list">
                        ...
                        <li class="list__item"><a class="list__item-link" href="blog.php">Tin tức</a></li>
                        <li class="list__item"><a class="list__item-link" href="contact.php">Liên hệ</a></li>
                        <li class="list__item">
